...
class Teste():
    def __init__(self, validator_persoana, validator_eveniment, repo_persoane, file_repo_persoane, repo_evenimente, service_persoane, service_evenimente, service_inscrieri, repo_inscrieri):
    ...
    def __ruleaza_teste_repo_persoane(self):
        ...
        adresa = "Strada Avram Iancu"
        persoana = Persoana(id_persoana, nume, adresa)
        assert(len(self.__repo_persoane.get_all()) == 5)
        self.__repo_persoane.adauga_persoana(persoana)
        assert(len(self.__repo_persoane.get_all()) == 6)
        ...
        try:
            self.__repo_persoane.adauga_persoana(alta_persoana_acelasi_id)
            assert False
    ...
    def __ruleaza_teste_repo_evenimente(self):
        ...
        descriere = "Test analiza"
        eveniment = Eveniment(id_eveniment, data, timp, descriere)
        assert(len(self.__repo_evenimente.get_all()) == 5)
        self.__repo_evenimente.adauga_eveniment(eveniment)
        assert(len(self.__repo_evenimente.get_all()) == 6)
        ...
        try:
            self.__repo_evenimente.adauga_eveniment(alt_eveniment_acelasi_id)
            assert False
        except RepoError as re:
    ...
    def __ruleaza_teste_rapoarte(self):
        ...
        assert self.__service_inscrieri.lista_de_evenimente_pentru_o_persoana_ordonata_alfabetic(1) == [3, 2, 1]
        assert self.__service_inscrieri.lista_de_evenimente_pentru_o_persoana_ordonata_dupa_data(1) == [1, 2, 3]
    ...
    def ruleaza_toate_testele(self):
        ...
        print("Teste repo persoane trecute cu succes!")
        ...
        print("Teste repo eveniment trecute cu succes!")
        self.__ruleaza_teste_service_evenimente()
        print("Teste service eveniment trecute cu succes!")
        self.__ruleaza_teste_rapoarte()
        print("Teste rapoarte trecute cu succes!")
